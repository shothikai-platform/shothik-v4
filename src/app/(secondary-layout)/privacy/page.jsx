...
export default function PrivacyPage() {
  ...
  const navigationItems = [
    ...
    {
      id: "marketing-automation-privacy",
      label: "Shothik AI Marketing Automation - Privacy Policy",
    },
    {
      id: "ma-section-1",
    ...
    {
      id: "ma-section-3",
      label: "3. User Rights (GDPR & CCPA)",
    },
    {
      id: "ma-section-4",
      label: "4. Data Deletion",
    },
    {
      id: "ma-section-5",
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto space-y-6 border-t py-12">
        <h1 id="marketing-automation-privacy" className="text-3xl font-bold">
        ...
        <div className="space-y-8">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-1" className="text-2xl font-semibold">1. Data Collection</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-2" className="text-2xl font-semibold">2. Data Usage</h2>
          ...
          <div className="space-y-4">
            <h2 id="ma-section-3" className="text-2xl font-semibold">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-4" className="text-2xl font-semibold">4. Data Deletion</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-5" className="text-2xl font-semibold">5. Security Measures</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-6" className="text-2xl font-semibold">6. Third-Party Services</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-7" className="text-2xl font-semibold">7. Compliance Standards</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-8" className="text-2xl font-semibold">8. Data Retention</h2>
            <p className="text-base leading-relaxed">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-9" className="text-2xl font-semibold">
          ...
          <div className="space-y-4">
            <h2 id="ma-section-10" className="text-2xl font-semibold">10. Contact & Support</h2>
            <p className="text-base leading-relaxed">
