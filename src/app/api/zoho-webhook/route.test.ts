...
describe('Zoho Webhook API', () => {
  ...
  it('should return 500 if ZOHO_WEBHOOK_URL is not defined (even if authenticated)', async () => {
  ...
  it('should post to ZOHO_WEBHOOK_URL and return 200 on success when authenticated', async () => {
    // Mock authenticated user
    (getAuthenticatedUser as any).mockResolvedValue({ id: 'user123' });
