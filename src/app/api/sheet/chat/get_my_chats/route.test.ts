...
describe('GET /api/sheet/chat/get_my_chats', () => {
  beforeEach(() => {
    ...
    mockSort.mockResolvedValue([{ _id: 'session1', userId: 'user123', title: 'Sheet 1' }]);
  ...
  it('should return 200 and return only user\'s sheet sessions when authenticated', async () => {
    ...
    expect(response.data).toEqual([{ _id: 'session1', userId: 'user123', title: 'Sheet 1' }]);
  });
});
