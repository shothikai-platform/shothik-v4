...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    expect((response as any).data.error).toBe('Unauthorized');
  });
  ...
  it('should return 200 and updated chat if authorized', async () => {
    const mockUser = { _id: 'user1' };
    const mockUpdatedChat = { _id: 'chat1', userId: 'user1', name: 'New Name' };
