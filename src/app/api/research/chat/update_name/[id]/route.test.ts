...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    // Insecure version might still call DB or just fail later.
    // We want to ENSURE it returns 401.
  ...
  it('should return 404 if chat belongs to another user (IDOR protection)', async () => {
    ...
    // Mock findOneAndUpdate to return null when scoped to user2
    mockFindOneAndUpdate.mockResolvedValue(null);
    // Mock findByIdAndUpdate (insecure version) to return the chat anyway
