...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 400 if name is missing, not a string, or too long', async () => {
  ...
  it('should return 200 and updated chat on success', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user1' });
    const mockChat = { _id: 'chat1', userId: 'user1', name: 'Valid New Name' };
    ...
    // Since mock NextResponse returns { data, options, status }
