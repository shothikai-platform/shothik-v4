...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    // Initial behavior is insecure (likely 200 or 500 if DB fails, but definitely not 401)
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Mocking findOneAndUpdate to return null because the chat with this ID and userId user2 doesn't exist
    ...
    // If it's insecure, it will return 200. We want 404/403.
