...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // If the code is fixed to use findOneAndUpdate with userId, this mock should return null
  ...
  it('should successfully update chat name if user owns the chat', async () => {
