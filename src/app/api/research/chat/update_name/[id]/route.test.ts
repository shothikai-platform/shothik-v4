...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should use findOneAndUpdate with userId for IDOR protection and correct field name', async () => {
    const mockUser = { _id: 'user123' };
    (getAuthenticatedUser as any).mockResolvedValue(mockUser);
    mockFindOneAndUpdate.mockResolvedValue({ _id: '123', userId: 'user123', name: 'Updated Name' });
