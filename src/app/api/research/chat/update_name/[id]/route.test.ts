...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should successfully update name and return the chat if authorized', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user123' });
    const mockUpdatedChat = { _id: 'chat1', userId: 'user123', name: 'Updated Name' };
    ...
    // @ts-ignore
    expect(response.data).toEqual(mockUpdatedChat);
  });
});
