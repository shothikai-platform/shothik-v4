...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 400 if name is invalid or missing', async () => {
  ...
  it('should return 400 if name exceeds length limit', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user123' });
  ...
  it('should successfully update chat name and return 200', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user123' });
