...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 400 if name is empty or whitespace-only', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user1' });
  ...
  it('should return 404 if chat belongs to another user or does not exist (IDOR protection)', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user1' });
  ...
  it('should return 200 and the updated chat upon successful rename', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user1' });
