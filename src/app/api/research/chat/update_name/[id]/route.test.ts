...
// Hoist mock functions for mongoose model
...
describe('PUT /api/research/chat/update_name/[id]', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    // Current behavior: 200 (returns chat) because it doesn't check auth
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Currently, findByIdAndUpdate returns it regardless of user.
    mockFindByIdAndUpdate.mockResolvedValue({ _id: 'chat1', userId: 'user1', name: 'Chat 1' });

    // For the future fix, findOneAndUpdate will return null.
  ...
  it('should update name if user owns chat', async () => {
