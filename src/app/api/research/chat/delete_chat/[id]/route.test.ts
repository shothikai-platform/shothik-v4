...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Mock findOneAndDelete to return null, simulating chat not found for the user
    mockFindOneAndDelete.mockResolvedValue(null);
    mockFindByIdAndDelete.mockResolvedValue({ _id: 'chat1', userId: 'user1' }); // In the vulnerable version, this will return the chat
