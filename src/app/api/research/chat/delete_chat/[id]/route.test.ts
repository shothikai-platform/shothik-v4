...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Mock findOneAndDelete to return null (simulating not found for this user)
    mockFindOneAndDelete.mockResolvedValue(null);

    // In current insecure implementation, findByIdAndDelete would be called and return the chat
    mockFindByIdAndDelete.mockResolvedValue({ _id: 'chat1', userId: 'user1' });
