...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should successfully delete chat and return success if authorized', async () => {
    (getAuthenticatedUser as any).mockResolvedValue({ _id: 'user123' });
    const mockDeletedChat = { _id: 'chat1', userId: 'user123', name: 'Chat 1' };
    mockFindOneAndDelete.mockResolvedValue(mockDeletedChat);
