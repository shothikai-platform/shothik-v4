...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Initially we use findByIdAndDelete which doesn't check userId
    // After fix we will use findOneAndDelete({ _id: id, userId: user._id })
    ...
    // Desired behavior: 404 (Not Found via findOneAndDelete with userId filter)
