...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    // Expected behavior after fix: 401 (Unauthorized)
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // In current insecure implementation, findByIdAndDelete is called and succeeds
    mockFindByIdAndDelete.mockResolvedValue({ _id: 'chat1', userId: 'user1' });

    // In secure implementation, findOneAndDelete returns null because it scopes by userId
    ...
    // Expected behavior after fix: 404 (Not Found via findOneAndDelete)
