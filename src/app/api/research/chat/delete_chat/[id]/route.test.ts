...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // In the secure implementation, findOneAndDelete({ _id: id, userId: user2 }) will be called.
    // If it returns null, we expect 404.
    ...
    // Expected to fail initially as the code uses findByIdAndDelete and doesn't check owner
