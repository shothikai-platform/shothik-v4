...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user or does not exist', async () => {
    ...
    mockFindOneAndDelete.mockResolvedValue(null); // Simulate chat not found or not owned by user
  ...
  it('should successfully delete chat if authorized and owned by user', async () => {
