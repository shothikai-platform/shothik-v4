...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 401 if user is not authenticated', async () => {
    ...
    // Current behavior: 200 (deletes chat because it doesn't check auth)
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Mock findByIdAndDelete to return something (it shouldn't be called if fixed)
    ...
    // Desired behavior: 404 (Not Found via findOneAndDelete with user scoping)
