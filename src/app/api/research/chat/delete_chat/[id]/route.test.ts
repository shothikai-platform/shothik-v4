...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user (IDOR protection)', async () => {
    ...
    // If the code is fixed to use findOneAndDelete, it will return null if user doesn't own it
    mockFindOneAndDelete.mockResolvedValue(null);
    // If it's still using findByIdAndDelete, it might succeed, which we want to prevent
