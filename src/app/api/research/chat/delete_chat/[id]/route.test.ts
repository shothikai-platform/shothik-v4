...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user', async () => {
    ...
    // Simulate that the chat doesn't exist for this user
    mockFindOneAndDelete.mockResolvedValue(null);

    // In current insecure version, it might call findByIdAndDelete
    ...
    // Desired behavior: 404 (Not Found via findOneAndDelete scoped by userId)
