...
describe('DELETE /api/research/chat/delete_chat/[id]', () => {
  ...
  it('should return 404 if chat belongs to another user (IDOR prevention)', async () => {
    ...
    // In secure version, findOneAndDelete returns null if not found for user
    mockFindOneAndDelete.mockResolvedValue(null);
    // In insecure version, findByIdAndDelete might still be called if not authenticated check is missing
