      ...
      <TooltipTrigger asChild>
        <label
          className={cn(
            ...
            "relative flex cursor-pointer items-center gap-1 rounded-lg px-3 py-2.5 text-sm font-bold transition-opacity has-[:focus-visible]:ring-2 md:gap-1.5 lg:gap-2",
