...
const ResearchContentWithReferences = React.memo(
  ({
    content,
    sources = [],
    isLastData,
    ...
    // Memoize the content string extraction
    ...
    // Memoize the processed content and marked result
    const { processedContent, htmlContent } = useMemo(() => {
      ...
      const processed = processContentWithReferences(contentStr);
...
ResearchContentWithReferences.displayName = "ResearchContentWithReferences";
