  ...
  const handleSubmit = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL + `/${process.env.NEXT_PUBLIC_PARAPHRASE_REDIRECT_PREFIX}/api`}/feedback`,
        // `${process.env.NEXT_PUBLIC_PARAPHRASE_API_URL + "/api"}/feedback`,
        {
          method: "POST",
          headers: {
