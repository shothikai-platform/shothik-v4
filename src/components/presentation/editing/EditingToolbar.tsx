    ...
    <TooltipProvider>
      <div className="bg-background absolute bottom-4 left-1/2 z-50 flex -translate-x-1/2 items-center gap-2 rounded-lg border p-2 shadow-lg">
        ...
        <div className="flex items-center gap-1 border-r pr-2">
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={!canUndo ? 0 : undefined} className="focus-visible:ring-2 focus-visible:ring-ring">
                <Button
                  variant="ghost"
                  size="icon-sm"
                  onClick={undoChange}
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={!canRedo ? 0 : undefined} className="focus-visible:ring-2 focus-visible:ring-ring">
                <Button
                  variant="ghost"
                  size="icon-sm"
                  onClick={redoChange}
        ...
        <div className="flex items-center gap-1 border-r pr-2">
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={elementDuplication.isDuplicating ? 0 : undefined} className="focus-visible:ring-2 focus-visible:ring-ring">
                <Button
                  variant="ghost"
                  size="icon-sm"
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={elementDeletion.isDeleting ? 0 : undefined} className="focus-visible:ring-2 focus-visible:ring-ring">
                <Button
                  variant="ghost"
                  size="icon-sm"
