      ...
      >
        ...
        >
          <Image
            src={gif}
            alt="feature"
            className={`${reverse ? "w-[90%]" : "relative left-20 w-[80%] max-md:left-0"} relative flex rounded-xl border border-gray-200 bg-white shadow-2xl max-md:w-full`}
          />
        </motion.div>
      </div>
