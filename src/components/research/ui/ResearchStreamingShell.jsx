...
const ResearchStreamingShell = ({
  ...
  // Optimization: Memoize sourceCount to prevent O(N) recalculation on every render
  ...
  // Optimization: Memoize imageCount to prevent O(N) recalculation on every render
