...
const MessageBubble = React.memo(
  ({ message, isLastData, isDataGenerating }) => {
    // Memoize the marked parsing to avoid re-parsing on every render if message hasn't changed
...
export default function ResearchContent({
  ...
  // Granular selectors to prevent re-renders on every stream event
