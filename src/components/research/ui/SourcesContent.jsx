      ...
      <div className="grid grid-cols-1 gap-1.5 sm:grid-cols-2 md:grid-cols-3">
        {sources.map((source, index) => (
          <a
            ...
            aria-label={`Source: ${source.title || "Untitled Source"}. Opens in a new tab.`}
          >
            <Card className="flex h-full flex-col transition-all duration-200 ease-in-out hover:-translate-y-px hover:shadow-md group-hover:border-primary/50">
              <CardContent className="flex-grow p-2">
                <div className="flex items-start gap-1.5">
                  ...
                  <ExternalLink className="text-muted-foreground/50 group-hover:text-muted-foreground mt-0.5 h-4 w-4 shrink-0 opacity-0 transition-all duration-200 group-hover:opacity-100" />
                </div>
              </CardContent>
            </Card>
          </a>
