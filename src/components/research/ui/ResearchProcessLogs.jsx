...
// Optimized: Wrapped in React.memo to prevent re-renders when parent state updates but item props are stable
...
const ResearchProcessLogs = ({
  ...
  // Optimized: Calculate activeIndex and summary without mapping/cloning the whole array
  // This avoids creating new object references for every event on every render, allowing React.memo to work effectively
