        ...
        <div className="mx-auto flex h-full w-full max-w-6xl items-center px-4">
          <div className="flex w-full items-center gap-4">
            <Tooltip>
              ...
              <TooltipContent>Go back to agents</TooltipContent>
            </Tooltip>
          ...
          <div className="bg-muted rounded-2xl border p-6 shadow-md">
            ...
            <div className="flex items-center justify-between">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <span
                    tabIndex={!inputValue.trim() || isLoading ? 0 : -1}
                    className="inline-block outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 rounded-full"
                  >
                    <Button
                      onClick={() => handleSend()}
