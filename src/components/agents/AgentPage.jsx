        ...
        <div className="mx-auto w-full max-w-6xl px-4">
          <div className="bg-muted rounded-2xl border p-6 shadow-md">
            ...
            <div className="flex items-center justify-between">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <span tabIndex={!inputValue.trim() || isLoading ? 0 : -1} className="focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none rounded-md">
                    <Button
                      onClick={() => handleSend()}
                      disabled={!inputValue.trim() || isLoading}
                      size="icon"
                      className="bg-primary hover:bg-primary/90 disabled:bg-muted disabled:text-muted-foreground h-10 w-10 disabled:pointer-events-none"
