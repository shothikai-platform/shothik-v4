  ...
  slidesAvailable: ${slidesData?.data?.length || 0}
                ...
                {previewTab === "thinking" && (
                  <div className="pb-8">
                    ...
                    <p className="text-muted-foreground text-sm">
                      The system is processing your request using multiple
                      agents. The progress bar above reflects the current status
            ...
            <div className="bg-muted rounded-2xl border p-6 shadow-md">
              ...
              <div className="flex items-center justify-between">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span
                      tabIndex={!inputValue.trim() || isLoading ? 0 : undefined}
                      className={
                        !inputValue.trim() || isLoading
                          ? "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-md inline-block"
                          : ""
                      }
                    >
                      <Button
