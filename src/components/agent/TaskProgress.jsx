      ...
      >
        {expanded ? (
          <>
            ...
            <button
              className="hover:bg-accent focus-visible:ring-ring absolute right-2 bottom-2 inline-flex items-center justify-center rounded-md p-1 transition-colors outline-none focus-visible:ring-2"
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="hover:bg-accent focus-visible:ring-ring inline-flex items-center justify-center rounded-md p-1 transition-colors outline-none focus-visible:ring-2"
                onClick={toggleExpanded}
                aria-label={
                  expanded ? "Collapse task progress" : "Expand task progress"
                }
