      ...
      >
        {expanded ? (
          <>
            ...
            <button
              className="hover:bg-accent absolute right-2 bottom-2 inline-flex items-center justify-center rounded-md p-1 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring"
              onClick={toggleExpanded}
              aria-expanded={expanded}
              aria-label={
                expanded ? "Collapse task progress" : "Expand task progress"
              }
            >
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <button
                className="hover:bg-accent inline-flex items-center justify-center rounded-md p-1 transition-colors outline-none focus-visible:ring-2 focus-visible:ring-ring"
                onClick={toggleExpanded}
                aria-expanded={expanded}
                aria-label={
                  expanded ? "Collapse task progress" : "Expand task progress"
