    ...
    <div className="flex w-full items-center justify-center">
      ...
      >
        ...
        >
          ...
          <span className={cn(loading || (!value && (!files || files.length === 0)) ? "focus-visible:ring-2 focus-visible:ring-ring" : "")} tabIndex={loading || (!value && (!files || files.length === 0)) ? 0 : undefined}>
            <Button
