          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span
                ...
                className="focus-visible:ring-ring inline-block rounded-md focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:outline-none"
              >
