    ...
    <div className="flex w-full items-center justify-center">
      ...
      >
        ...
        >
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                aria-label={filesRef?.current?.files?.length ? `${filesRef.current.files.length} Files selected` : "Attach files"}
              >
                {files && (
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={loading ? 0 : -1} className="focus-visible:ring-2 focus-visible:ring-ring rounded-md">
