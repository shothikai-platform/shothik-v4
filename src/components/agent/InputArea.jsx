    ...
    <div className="flex w-full items-center justify-center">
      ...
      >
        ...
        >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span className="focus-visible:ring-2 focus-visible:ring-ring" tabIndex={loading || (!value && !files) ? 0 : undefined}>
                <Button disabled={loading || (!value && !files)} type="submit" size="icon" aria-label="Send message">
                  {loading ? (
