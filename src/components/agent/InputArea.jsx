    ...
    <div className="flex w-full items-center justify-center">
      ...
      >
        ...
        >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <span tabIndex={loading ? 0 : undefined} className="focus-visible:ring-2 focus-visible:ring-ring rounded-md">
                <Button disabled={loading} type="submit" size="icon" aria-label={loading ? "Sending message" : "Send message"}>
                  {loading ? (
