...
## 2025-02-18 - Email Input Type UX
**Learning:** Email input fields without `type="email"` fail to trigger native mobile email keyboards and browser validation, reducing UX quality.
**Action:** Always ensure email input fields use `type="email"` to optimize keyboard layouts and leverage native browser validation.
